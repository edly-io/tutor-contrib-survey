...
"""
survey_api documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'survey_api',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edly/survey_api",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'survey_api'),
                os.path.join(root_path, 'survey_api/migrations')])
